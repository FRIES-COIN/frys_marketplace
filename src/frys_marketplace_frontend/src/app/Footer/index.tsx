    ...
    <footer className="bg-black text-yellow-400 py-10 px-6 mt-auto">
      <div className="container mx-auto flex flex-col space-y-8 lg:space-y-0 lg:flex-row lg:justify-between lg:items-start">
        ...
        <div className="flex flex-col items-center lg:items-start space-y-4">
          <Logo />
          <p className="text-gray-400 text-center lg:text-left">NFT marketplace</p>
          <p className="text-gray-400 text-center lg:text-left">Join our community</p>
        ...
        <div className="text-center lg:text-left">
          ...
          <ul className="space-y-2 mt-4">
            ...
            <li>
              <a href="#" className="hover:text-white">Rankings</a>
            </li>
            <li>
              <a href="#" className="hover:text-white">Connect a wallet</a>
            </li>
          </ul>
        </div>
        ...
        <div className="text-center lg:text-left">
          ...
          <form className="flex flex-col sm:flex-row items-center sm:items-start mt-4 space-y-2 sm:space-y-0">
            <input
              ...
              className="px-4 py-2 rounded-md sm:rounded-l-md sm:rounded-r-none bg-gray-800 text-white border-none outline-none focus:ring-2 focus:ring-yellow-400 w-full sm:w-auto"
            />
            <button
              type="submit"
              className="bg-yellow-400 text-black px-4 py-2 rounded-md sm:rounded-r-md sm:rounded-l-none hover:bg-yellow-500 transition-colors w-full sm:w-auto"
            >
              Subscribe
            </button>
          </form>
